...
Current version: `deco-storyboard-designer@2026-07-28-v1.19-work-definition-inheritance` (inherits and displays the upstream work definition without originating it). | v1.18 functional-only-scope.
